...
function ArticlesPage() {
  ...
  return (
    <main className="relative isolate min-h-screen overflow-hidden bg-stone-50/70 text-stone-900 selection:bg-amber-200/70 dark:bg-stone-950/65 dark:text-stone-100">
      <div
        aria-hidden="true"
      ...
      <section className="mx-auto w-full max-w-7xl px-4 pb-20 pt-10 sm:px-6 sm:pt-16 lg:px-8 lg:pb-28">
        <header className="relative overflow-hidden rounded-[2rem] border border-amber-900/10 bg-white/65 px-6 py-10 shadow-[0_30px_90px_-45px_rgba(120,53,15,0.4)] backdrop-blur-xl sm:px-10 sm:py-14 lg:px-16 lg:py-20 dark:border-amber-200/10 dark:bg-stone-900/60">
