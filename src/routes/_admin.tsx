...
import { Menu, X, LayoutDashboard, BookOpen, Users, ShieldAlert, LogOut, Library, Newspaper, Sparkles } from "lucide-react";
...
const ADMIN_NAV = [
  ...
  { to: "/admin/ziyarat" as const, label: "Ziyārat", icon: Sparkles },
...
function AdminLayout() {
  ...
  return (
    <div className="admin-shell mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-10">
      {/* Header */}
